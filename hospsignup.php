...
<!--End of Tawk.to Script-->
    ...
    <form class="modal-content" method="POST" action="hospprocess.php">
    <div class="container">
      <h1>Sign Up</h1>
      <p>Please fill in this form to create an account.</p>
      <hr>
      <label for="shopname"><b>Hospital Name</b></label>
      <input type="text"  class="form-control" placeholder="Hospital Name" name="hospname" required>
