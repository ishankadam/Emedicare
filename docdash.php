                    ...
                    ?>
                            <div class="col-sm-12 col-md-3 col-lg-3" style="margin: 2vh;">
                                <div class="card" style="padding: 20px;">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p><b>Dr Name :</b> <?php echo $drname; ?> </p>
											<p><b>Specialization :</b> <?php echo $spec; ?> </p>
											...
											<p><b>Contact :</b> <?php echo $contact; ?> </p>
                                                ...
                                                <button class="btn btn-secondary" id="visit" name="visit"  onclick="getLocation()">Visit</button>
